...
const CategoryFormPage = () => {
  ...
  const handleSettings = (category) => {
    console.log(category, "cattttttttttttteeeeeeeeeeeeeegggggggg");
    setSelectedCategory(category);
    setOpen(true);
  };

  // console.log(selectedCategory,"seleeeeeeeeeeeeeeeeeeeeellllllllllllcategoatry")
  ...
  const handleSubmitUpdate = async (e) => {
    ...
    try {
      ...
      const data = await axios.put(
        `/api/package/category/${selectedCategory._id}`,
        { name: name.toUpperCase() },
        config
      );
