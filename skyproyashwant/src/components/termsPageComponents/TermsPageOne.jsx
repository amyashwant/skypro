          ...
          <div className="col-sm-12">
            ...
            <ul className="list-style">
              ...
              <li>
                ...
                Terms and Conditions when accessing or using Skypro Communication
                Services.
              </li>
              ...
              <li>
                ...
                Communication complies with applicable laws and regulations. Any
                unauthorized use is strictly prohibited.
              </li>
              <h4>Data Security and Privacy:</h4>
              <li>
                We prioritize the security and privacy of your information.
                Skypro Communication takes industry-standard measures to protect your
              ...
              <li>
                ...
                the specified fees. Skypro Communication  reserves the right to modify
              ...
              <li>
                ...
                services to users who violate our terms and conditions. Subject to
                applicable cancellation policies, Users may terminate their
                Accounts at any time.
              </li>
              <h4>Intellectual Property:</h4>
              <li>
                All content and materials provided by Skypro Communication  are protected
              ...
              <li>
                Skypro Communication may update these Terms and Conditions from time to
